                    ...
                    {data.map((customer) => (
                        <div
                            ...
                            className={`
                                ...
                                animate-pulse
                                ${customer.orderStatus === 'preparing' ? 'bg-orange-500 shadow-orange-500/50' :
                                    customer.orderStatus === 'onTheWay' ? 'bg-blue-500 shadow-blue-500/50' :
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className={`
                                ...
                                ${customer.orderStatus === 'preparing' ? 'bg-orange-500' :
                                    customer.orderStatus === 'onTheWay' ? 'bg-blue-500' :
                                        'bg-green-500'
                                }
                            `}></div>
                            <div>
